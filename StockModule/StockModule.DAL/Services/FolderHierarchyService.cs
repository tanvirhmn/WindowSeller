...
namespace StockModule.DAL.Services
{
    public class FolderHierarchyService : EntityService<FolderHierarchy>, IFolderHierarchyService
    {
        ...
        List<FolderHierarchy> IFolderHierarchyService.GetAllParentFoldersByMaterialId(int materialId)
        {
            List<FolderHierarchy> fdlHis = new List<FolderHierarchy>();

            int ? folderHierarchyId = _dbContext.View_StockSettinsMaterialView_FolderHierarchies.Single(vmStockMat => vmStockMat.Id == materialId).FolderHierarchyId;
