...
namespace StockModule.DAL.Migrations
{
    ...
    [Migration("20221130084238_externalMovements")]
    partial class externalMovements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntusEntity.Models.ExternalMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ExternalMovement");
                });
            ...
            modelBuilder.Entity("IntusEntity.Models.ExternalMovementArchive", b =>
                {
                    b.HasBaseType("IntusEntity.Models.ExternalMovement");

                    b.HasDiscriminator().HasValue("ExternalMovementArchive");
                });
